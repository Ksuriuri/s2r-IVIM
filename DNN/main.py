...
# test_save_path = r'/home/public/Documents/hhy/IVIM/UDA_fake/DNN'
...
# [83, 65, 50, 35, 15, 5]
train_num = 5
save_path_real = r'/home/public/Documents/hhy/IVIM/UDA_real/DNN_%s' % str(train_num)
...
x_fit = np.concatenate([np.load(bf)['x'][::6][..., 1:] for bf in b_files[:train_num]], 0)
...
def model(inputs, b_v, reuse=False, mask_=None):
    ...
    with tf.variable_scope("fit", reuse=reuse):
        ...
        net = dense(inputs, 8, w_init=w_init, b_init=b_init, name='d1', act=tf.nn.elu)
    ...
    for epoch in range(num_epochs):
        ...
        for n_batch in range(num_batches):
            ...
            _, l2, ivim_p = sess.run(
                ...
                feed_dict={x_fit_: batch_fit}  # , x_gt: batch_gt, ivim_: batch_ivim, mask: batch_mask
            )
