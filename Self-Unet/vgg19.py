...
class VGG19(object):
    def __init__(self, input_image=None, model_path='models/VGG19/imagenet-vgg-verydeep-19.mat',
                 final_layer='relu5_1', mean_pixel=(123.68, 116.779, 103.939)):
        ...
        self.mean_pixel = mean_pixel  # (123.68, 116.779, 103.939)  # RGB
        self.layer_names = (
